...
class Seeder {
  static async seed() {
    try {
      ...
      await pool.query(
        "INSERT INTO adoptable_pets (name, img_url, age, vaccination_status, adoption_story, adoption_status, type_id ) VALUES ('Nala', 'https://science.sciencemag.org/content/sci/365/6449/136.7/F1.large.jpg?width=800&height=600&carousel=1', 3, true, 'This darling girl is ready to be shown off to your friends! Nala is a gorgeous female puppy that wants to light up your life. Nala will have a nose to tail vet check and arrive with a current health certificate. She will love running around town with you doing errands or snuggling at home to relax. Nala is eager to find her forever home. Do nott miss out on this spectacular companion.', true, 1);"
      )
      await pool.query(
